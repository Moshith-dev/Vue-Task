    ...
    <div class="my-10 md:my-20">
      ...
      <div class="flex flex-col justify-around gap-8 px-4 md:flex-row md:px-5">
        ...
        <div class="flex justify-center anim-slide-left">
          <img src="/assets/Shape_App.png" alt="download" class="w-[300px] md:w-[600px] h-auto " />
        </div>
      </div>


      <div class="relative w-full mt-10 md:mt-0">
        <img class="w-full max-w-[1200px] ml-auto mr-4 md:mr-10" src="/assets/ground_shape.png" alt="ground shape" />
      </div>
    </div>
  </section>
</template>
